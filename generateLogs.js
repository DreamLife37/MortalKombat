...
export function generateLogs(type, player1, player2, change) { //вторым аргументом передаем игрока который бъет 
    console.log(type);
    let text = '';
    let el = '';
    ...
    switch (type) {
        ...
        case 'hit':
            ...
            console.log(text);
            // getHp();
            el = `<p> ${time}  ${text}  -${change} ${player2.hp || player1.hp}/100</p>`;
